## [ZelCash](https://zel.cash/) Desktop GUI Wallet known security issues
...
the wallet. In addition users should make sure they are in control of all addresses that are used as receiving addresses for ZelCash. If in 
...
The ZelCash Desktop GUI Wallet is not compatible with applications that modify the ZelCash `wallet.dat` file. The wallet should not be used
